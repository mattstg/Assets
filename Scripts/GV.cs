...
public class GV
{
    ...
    public static readonly float ANT_STATE_TIMER = 2f; //length of time they do
	...
	public static readonly float POISON_TO_ENRGY = 10f; //-X energy % hp per unity of poison
    ...
    public static readonly float PHEROMONE_MAX_OPACITY = .95f;
	public static readonly float PHEROMONE_MIN_OPACITY = .35f;
	...
	public static readonly int MAX_BORN_ANTS_PER_SEC = 1;
